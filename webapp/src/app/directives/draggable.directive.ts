import {
  Directive, ElementRef, Renderer, Input, Output, OnInit, HostListener, EventEmitter,
  AfterViewInit
} from '@angular/core';
...
export class DraggableDirective implements AfterViewInit{
  ...
  ngAfterViewInit() {
    this.handle = _.find((<HTMLElement>this.el.nativeElement).children, {className: 'window-title'}) as HTMLElement;
    if (this.allowDrag) {
      let element = this.handle ? this.handle : this.el.nativeElement;
      this.renderer.setElementClass(element, 'ng-draggable', true);
    }
